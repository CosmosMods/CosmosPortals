...
public class EventManager {
	...
	public static void registerOresForGeneration() {
		overworldOres.add(register("dimensional_ore", Feature.ORE.configured(new OreConfiguration(OreFeatures.NATURAL_STONE, ModBusManager.COSMIC_ORE.defaultBlockState(), 4))));//.count(24).squared().rangeUniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(48))));
	}
