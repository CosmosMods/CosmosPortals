...
import com.tcn.cosmoslibrary.client.ui.screen.option.CosmosOptionsList.Entry;
...
public final class ScreenConfiguration extends Screen {
	...
	public ScreenConfiguration(Screen parent) {
		super(ComponentHelper.locComp(ComponentColour.LIGHT_GRAY, true, "cosmosportals.gui.config.name"));
	...
	protected void init() {
		...
		this.optionsRowList.addBig(
			new CosmosOptionTitle(ComponentColour.GRAY, true, "cosmosportals.gui.config.general_title")
		);
		...
		this.optionsRowList.addBig(
			new ProgressOption(
				...
				(options, option) -> ComponentHelper.locComp(ComponentColour.WHITE, false, "cosmosportals.gui.config.size_slide").append(ComponentHelper.locComp(ComponentColour.GREEN, true, " [ " + option.get(options) + " ]"))
			)
		);
		
		this.optionsRowList.addSmall(
			new CosmosOptionBoolean(
				ComponentColour.ORANGE, false, "cosmosportals.gui.config.sound.travel", TYPE.YES_NO,
			...
			new CosmosOptionBoolean(
				ComponentColour.ORANGE, false, "cosmosportals.gui.config.sound.ambient", TYPE.YES_NO,
		...
		this.optionsRowList.addBig(
			new CosmosOptionTitle(ComponentColour.GRAY, true, "cosmosportals.gui.config.messages_title")
		);
		
		this.optionsRowList.addSmall(
			new CosmosOptionBoolean(
				ComponentColour.CYAN, false, "cosmosportals.gui.config.message.info", TYPE.ON_OFF,
			...
			new CosmosOptionBoolean(
				ComponentColour.CYAN, false, "cosmosportals.gui.config.message.debug", TYPE.ON_OFF,
		...
		this.optionsRowList.addBig(
			new CosmosOptionTitle(ComponentColour.GRAY, true, "cosmosportals.gui.config.visual_title")
		);
		
		this.optionsRowList.addSmall(
			new CosmosOptionBoolean(
				ComponentColour.LIGHT_BLUE, false, "cosmosportals.gui.config.frame_textures", TYPE.ON_OFF,
			...
			new CosmosOptionBoolean(
				ComponentColour.LIGHT_BLUE, false, "cosmosportals.gui.config.portal_textures", TYPE.ON_OFF,
		...
		this.optionsRowList.addSmall(
			new CosmosOptionBoolean(
				ComponentColour.LIGHT_BLUE, false, "cosmosportals.gui.config.labels", TYPE.ON_OFF,
			...
			new CosmosOptionBoolean(
				ComponentColour.LIGHT_BLUE, false, "cosmosportals.gui.config.particles", TYPE.ON_OFF,
		...
		this.addRenderableWidget(new Button(
			...
			ComponentHelper.locComp(ComponentColour.GREEN, true, "cosmosportals.gui.done"), (button) -> { this.onClose(); }
		));
	}
	...
	public BaseComponent[] getTooltipForChild(double index) {
		...
		if (index == 1.0D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.size_info"),
					ComponentHelper.locComp(ComponentColour.RED, false, "cosmosportals.gui.config.size_info_two"),
					ComponentHelper.locComp(ComponentColour.LIGHT_RED, false, "cosmosportals.gui.config.size_info_three") };
		} else if (index == 2.3D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.sound.travel_info") };
		} else if (index == 2.6D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.sound.ambient_info") };
		} else if (index == 4.3D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.message.info_desc"), ComponentHelper.locComp(ComponentColour.RED, true, "cosmosportals.gui.config.message.restart") };
		} else if (index == 4.6D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.message.debug_desc"), ComponentHelper.locComp(ComponentColour.RED, true, "cosmosportals.gui.config.message.restart") };
		} else if (index == 6.3D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.frame_textures_info") };
		} else if (index == 6.6D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.portal_textures_info") };
		} else if (index == 7.3D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.labels_info") };
		} else if (index == 7.6D) {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.particles_info") };
		} else {
			return new BaseComponent[] { ComponentHelper.locComp(desc, false, "cosmosportals.gui.config.missing") };
		}
	}
