...
public class ContainerPortalDock extends AbstractContainerMenu {
	...
	public ContainerPortalDock(int indexIn, Inventory playerInventoryIn, Container contentsIn, ContainerLevelAccess callableIn, BlockPos pos) {
		super(ModBusManager.CONTAINER_TYPE_DOCK, indexIn);
		this.pos = pos;
